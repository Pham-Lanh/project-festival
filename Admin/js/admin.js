...
var loadUser=[];
var loadCart=[];
function Cart(ticket,tour,hotel) {
    this.Tichket=ticket;
    this.Tour=tour;
    this.Hotel=hotel;
...
function PushData(id,username,password,email,sdt,fullname,birthday,address,avatar,idcart){
    return '<tr>'
        ...
        +'   <td><i data-toggle="modal" data-target="#squarespaceModal1" class="fas fa-user-minus deleteUser" data-id="' + id + '" ></i></td>'
        +'   </tr>';
